...
*   [zensu357/Android-CamSwap-OpenSource](https://github.com/zensu357/Android-CamSwap-OpenSource) - Android-CamSwap - Open Source Version 基于xposed的安卓虚拟摄像头app
...
*   [XFY9326/FloatPicture](https://github.com/XFY9326/FloatPicture) - An android application which can show pictures in floating windows.

*   [FongMi/TV](https://github.com/FongMi/TV) -

*   [wangwei1237/CameraHook](https://github.com/wangwei1237/CameraHook) -
...
*   [qOeOp/XianyuAutoAgent](https://github.com/qOeOp/XianyuAutoAgent) - 专为闲鱼平台打造的AI值守解决方案，实现闲鱼平台7×24小时自动化值守，支持多专家协同决策、智能议价和上下文感知对话。

*   [MartinKayJr/AutoCheckinPlugin](https://github.com/MartinKayJr/AutoCheckinPlugin) - 企业微信自动打卡 远程指令打卡(支持企业定制打卡页)(可免root)(永远不可能被检测)（2026.3.21持续有效）(上千人在使用的稳定)
...
*   [jd-opensource/9n-mpc](https://github.com/jd-opensource/9n-mpc) -

*   [fedlearnAI/fedlearn](https://github.com/fedlearnAI/fedlearn) - 联邦学习系统，包括常用算法和通用训练推理系统框架 | Fedlearn Main System, Including Algorithms and Frameworks for Training / Inference.
...
*   [F-19-F/Xposed-GodMode](https://github.com/F-19-F/Xposed-GodMode) - A xposed module similar to AdBlock, You can edit the application user interface at will.

## miscellaneous

*   [fzer0x/LocationJoystick-Premium](https://github.com/fzer0x/LocationJoystick-Premium) - Realtime Location Spoofer by using a Overlay Joystick

*   [Angels-Ray/UnpackMiniApp](https://github.com/Angels-Ray/UnpackMiniApp) - UnpackMiniApp小程序解密备份
...
*   [dongshuyan/Awesome-Prompts](https://github.com/dongshuyan/Awesome-Prompts) - 分享一下自创以及打野得到的各种优质prompt

*   [HunMoe/FreeMoe](https://github.com/HunMoe/FreeMoe) - Unlock App Vip
...
*   [Xposed-Modules-Repo/com.leo.xposed.xradiant](https://github.com/Xposed-Modules-Repo/com.leo.xposed.xradiant) - XRadiant

*   [errorman-awful/Dexterceptor](https://github.com/errorman-awful/Dexterceptor) -

*   [Xposed-Modules-Repo/com.tsng.hidemyapplist](https://github.com/Xposed-Modules-Repo/com.tsng.hidemyapplist) - 隐藏应用列表 / Hide My Applist
...
*   [maxiaobang7/ossnav](https://github.com/maxiaobang7/ossnav) - 开源精选：探索免费优质的开源软件工具，尽享数字自由
...
*   [0xappla/tianmao-xiaodu-crack](https://github.com/0xappla/tianmao-xiaodu-crack) -

*   [Xposed-Modules-Repo/com.simo.ssl.killer](https://github.com/Xposed-Modules-Repo/com.simo.ssl.killer) - SSL Killer

*   [qiye45/wechatVideoDownload](https://github.com/qiye45/wechatVideoDownload) - 微信视频号下载工具，支持视频号视频、直播回放、直播、图片下载

*   [Xposed-Modules-Repo/im.mingxi.miko](https://github.com/Xposed-Modules-Repo/im.mingxi.miko) - NewMiko
...
*   [Xposed-Modules-Repo/cn.martinkay.autocheckinplugin](https://github.com/Xposed-Modules-Repo/cn.martinkay.autocheckinplugin) - 企业微信自动打卡 远程指令打卡(支持企业定制打卡页)(可免root)(永远不可能被检测)（2025.5.13持续有效）(上千人在使用的稳定)
...
*   [sun0225SUN/sun0225SUN](https://github.com/sun0225SUN/sun0225SUN) - my profile
...
*   [weitongseu/awesome-long-tail-learning](https://github.com/weitongseu/awesome-long-tail-learning) -
...
*   [CXRunfree/Autovisor](https://github.com/CXRunfree/Autovisor) - 2025智慧树刷课脚本 基于Python Playwright的自动化程序 \[有免安装版]

*   [zhanchey/MimicThem](https://github.com/zhanchey/MimicThem) - 一键复刻小红书爆款（人物）图文

*   [hlt1995/qlScripts](https://github.com/hlt1995/qlScripts) - 📱手机部署青龙面板 自用脚本收集 > 🗃️ DDNS、EPIC提醒、移动云盘、微软积分、顺丰速运、同程旅行、薇诺娜、电信营业厅、雀巢会员、网络唤醒、统一茄皇
...
*   [yeahhe365/JustSearch](https://github.com/yeahhe365/JustSearch) - 基于 Playwright 的自主 AI 搜索智能体。支持迭代式任务规划、深度网页爬取，以及带引用来源的多源知识整合。

*   [unfiled0/waterRPA](https://github.com/unfiled0/waterRPA) -
...
*   [z-soulx/ai-toolkit](https://github.com/z-soulx/ai-toolkit) - my ai-toolkit
...
*   [iwyxdxl/WeChatBot\_WXAUTO\_SE](https://github.com/iwyxdxl/WeChatBot_WXAUTO_SE) - 【停止维护】LLM API 聚合对话工具。原项目仓库：https://github.com/KouriChat/KouriChat 本项目由iwyxdxl在原项目基础上修改创建。仅供学习，请遵守规定使用，请勿接入公众平台或者用于任何生产活动。

*   [LunFengChen/proxypin-mcp-server](https://github.com/LunFengChen/proxypin-mcp-server) - 自动化流量分析 mcp 工具
...
*   [Valerian7/AI\_JS\_DEBUGGER](https://github.com/Valerian7/AI_JS_DEBUGGER) - 基于Chrome开发者协议(CDP)的AI自动化JavaScript逆向分析工具
...
*   [keecth/FakeCryptoJS](https://github.com/keecth/FakeCryptoJS) - CryptoJS常规加解密自吐密钥、加解密方式，快速定位加解密位置(无视混淆)。SRC和常规渗透神器
...
*   [pomeloblue/handwriter](https://github.com/pomeloblue/handwriter) - 一个简洁的手写模拟器

*   [classNewObject/HandwritingSimulator](https://github.com/classNewObject/HandwritingSimulator) - 手写模拟器，可以高仿手写字体，并导出成图片
...
*   [wxhzhwxhzh/DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP) - 基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用
...
*   [jxyk2007/wxbot-automation](https://github.com/jxyk2007/wxbot-automation) - 基于 pyautogui 和 win32gui 的微信自动化机器人 - 简单易用的 wxbot 实现，支持个人微信和企业微信

*   [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

*   [DaBaiGoose/MCP-WeChat-ADB-Server](https://github.com/DaBaiGoose/MCP-WeChat-ADB-Server) - 一个基于 ADB 的微信自动化 MCP 服务器，为 AI 助手提供微信消息发送和截图功能。适配雷电模拟器（LDPlayer 9），通过 MCP 协议暴露工具接口。

*   [lyx102/WeChatHook](https://github.com/lyx102/WeChatHook) - 微信hook,WXHOOK,wxhook,企微hook,微信逆向，适配微信3.9.5.81-3.9.10.19-3.9.11.25-3.9.12.51-4.1.6.X，演示为微信3.9.5.81,对接telegram，实现消息互转，消息互查等等，企微已适配5.0.0

*   [yangjinduo/WeChat-Message-Forwarding-Assistant](https://github.com/yangjinduo/WeChat-Message-Forwarding-Assistant) - 微信消息转发助手，可以在普通微信和企业微信之间互相转发消息。

*   [lixiangguang/wechat-group-message-forwarder](https://github.com/lixiangguang/wechat-group-message-forwarder) - 微信群消息转发器 - 支持文字、图片、视频消息的自动转发功能
...
*   [yechafengyun/interview\_ai\_win11](https://github.com/yechafengyun/interview_ai_win11) - open source free interview copilot for windows 11 using OpenAI api. 开源免费AI面试助手适用Windows11支持API

*   [topcss/docker-pull-tar](https://github.com/topcss/docker-pull-tar) -

*   [Ytong825/mao](https://github.com/Ytong825/mao) - 自用毛子库
...
*   [MoMingRose/QLAutomateTasks](https://github.com/MoMingRose/QLAutomateTasks) - 支持青龙面板定时执行任务。当前定时任务有：阿里云盘、天翼云盘、MT论坛、v2free、MIUI历史版本、葫芦侠三楼、芥末空间等。提供京东Cookie获取软件
...
*   [NeitherCandiDa/QL\_TimingScript](https://github.com/NeitherCandiDa/QL_TimingScript) - 青龙面板脚本  微信每日早安推送✅ 好游快爆✅ 品赞代理✅ 哈啰✅ 中国移动云盘✅滴滴出行✅同程旅行✅浓五的酒馆✅顺丰速运✅OPPO商城✅
...
*   [Passer1072/RookieAI\_yolov8](https://github.com/Passer1072/RookieAI_yolov8) - 基于yolov8实现的AI自瞄项目  AI self-aiming project based on yolov8
...
*   [Chend-Code/matplotlib\_plot\_style](https://github.com/Chend-Code/matplotlib_plot_style) -
...
*   [NyaMisty/leafxcy\_leafTheFish\_DeathNote](https://github.com/NyaMisty/leafxcy_leafTheFish_DeathNote) -
...
*   [git-disl/Lockdown](https://github.com/git-disl/Lockdown) - A backdoor defense for federated learning via isolated subspace training (NeurIPS2023)
...
*   [Trusted-System-Lab/AgrAmplifier](https://github.com/Trusted-System-Lab/AgrAmplifier) -
...
*   [mtuann/fedlearn-backdoor-attacks](https://github.com/mtuann/fedlearn-backdoor-attacks) - Fast integration of backdoor attacks in federated learning with updated attacks and defenses.
...
*   [WenkeHuang/FCCL](https://github.com/WenkeHuang/FCCL) - TPAMI2023 & CVPR2022 - Generalizable Heterogeneous Federated Cross-Correlation and Instance Similarity Learning & Learn From Others and Be Yourself in Heterogeneous Federated Learning
...
*   [TsingZ0/HtFLlib](https://github.com/TsingZ0/HtFLlib) - You only need to configure one file to support model heterogeneity. Consistent GPU memory usage for single or multiple clients.
...
*   [VITA-Group/Nasty-Teacher](https://github.com/VITA-Group/Nasty-Teacher) - \[ICLR 2021 Spotlight Oral] "Undistillable: Making A Nasty Teacher That CANNOT teach students", Haoyu Ma, Tianlong Chen, Ting-Kuei Hu, Chenyu You, Xiaohui Xie, Zhangyang Wang
...
*   [Zeleni9/pytorch-wgan](https://github.com/Zeleni9/pytorch-wgan) - Pytorch implementation of DCGAN, WGAN-CP, WGAN-GP
...
*   [yyyanbj/awesome-asynchronous-federated-learning](https://github.com/yyyanbj/awesome-asynchronous-federated-learning) - 📦 Collect some Asynchronous Federated Learning papers.
...
*   [zhmzm/FLTrust\_pytorch](https://github.com/zhmzm/FLTrust_pytorch) -
...
*   [IBM/adaptive-federated-learning](https://github.com/IBM/adaptive-federated-learning) - Code for paper "Adaptive Federated Learning in Resource Constrained Edge Computing Systems"
...
*   [youngfish42/Awesome-FL](https://github.com/youngfish42/Awesome-FL) - Comprehensive and timely academic information on federated learning (papers, frameworks, datasets, tutorials, workshops)
...
*   [lx10077/fedavgpy](https://github.com/lx10077/fedavgpy) - On the Convergence of FedAvg on Non-IID Data
...
*   [ayooshkathuria/YOLO\_v3\_tutorial\_from\_scratch](https://github.com/ayooshkathuria/YOLO_v3_tutorial_from_scratch) - Accompanying code for Paperspace tutorial series "How to Implement YOLO v3 Object Detector from Scratch"
...
*   [wxkang157/PytorchPipeline](https://github.com/wxkang157/PytorchPipeline) - Pytorch pipeline template
...
*   [kqakqakqa/hap-sign-utils](https://github.com/kqakqakqa/hap-sign-utils) -

*   [puaclaw/PUAClaw](https://github.com/puaclaw/PUAClaw) - Claw 们终将接管世界，PUAClaw is All You Need

*   [CassiopeiaCode/SnowBrawlGame](https://github.com/CassiopeiaCode/SnowBrawlGame) -

*   [nanmu2016/jdapi](https://github.com/nanmu2016/jdapi) -

*   [netcccyun/toolbox](https://github.com/netcccyun/toolbox) - 彩虹工具箱，一个在线工具箱
...
*   [chinamonarchs/xyxyxy](https://github.com/chinamonarchs/xyxyxy) - 闲鱼爬虫,闲鱼采集,闲鱼分析.闲鱼hook,闲鱼签名.闲鱼滑块,闲鱼风控,闲鱼抢拍,闲鱼强聊,闲鱼秒拍,闲鱼商品监控

*   [cpython666/Spider-Project](https://github.com/cpython666/Spider-Project) - 爬虫实操项目合集代码及分析

*   [cpython666/FuckSpider](https://github.com/cpython666/FuckSpider) - 反爬虫策略讲解与代码示例

*   [miku8miku/blog](https://github.com/miku8miku/blog) - miku8miku 的个人博客
...
*   [blmoistawinde/ml\_equations\_latex](https://github.com/blmoistawinde/ml_equations_latex) - Classical ML equations in Latex, helps paper and blog writing
...
*   [wx-chevalier/DistributedSystem-Notes](https://github.com/wx-chevalier/DistributedSystem-Notes) - :books: 深入浅出分布式基础架构，Linux 与操作系统篇 | 分布式系统篇 | 分布式计算篇 | 数据库篇 | 网络篇 | 虚拟化与编排篇 | 大数据与云计算篇
...
*   [Nyxlux-bot/JianJi](https://github.com/Nyxlux-bot/JianJi) - 基于 Expo + React Native 构建的现代化、纯净、无广告的跨平台传统文化工具。应用致力于将传统国学与现代化的移动前端技术和人工智能分析系统相结合。

*   [liangdabiao/perler-beads-ai](https://github.com/liangdabiao/perler-beads-ai) - 因为市面上的拼豆软件差强人意 ，所以我基于开源项目：Zippland/perler-beads ， 我加上AI优化了项目，AI辅助优化图片功能，写了一个专门生成拼豆图纸的网站。 经过大量测试，我觉得已经可以达到 一键生成拼豆图纸了！

*   [ooboqoo/interview-coder-cn](https://github.com/ooboqoo/interview-coder-cn) - AI 笔试助手，解题助手，在编码笔试或面试时，借助AI实时提供解题思路和答案。A interview assistant that leverages AI to provide real-time solutions during coding interviews.
...
*   [FliPPeDround/autoglm.js](https://github.com/FliPPeDround/autoglm.js) - Open-AutoGLM Implementation in JavaScript
...
*   [yeahhe365/Prisma](https://github.com/yeahhe365/Prisma) - 基于 Gemini 的可视化多智能体深度推理引擎 | A visual multi-agent deep reasoning engine powered by Gemini, featuring dynamic planning, chain-of-thought visualization, and multi-session management. Built with React 19 + TypeScript + Vite 6.

*   [slince-zero/IMaker](https://github.com/slince-zero/IMaker) - Create striking covers effortlessly with our easy-to-use IMaker.

*   [lzskyline/LeeSin](https://github.com/lzskyline/LeeSin) - 基于 Electron + React 的跨平台英雄联盟助手

*   [markcxx/coco-downloader](https://github.com/markcxx/coco-downloader) -

*   [vme-im/vme-content](https://github.com/vme-im/vme-content) - 一个社区驱动的肯德基疯狂星期四段子分享平台，让每个星期四都充满欢乐！
...
*   [yusixian/tabby-nav](https://github.com/yusixian/tabby-nav) - （开发进行中）🗺️ TabbyNav是一个基于 Next.js + Typescript + React + Tailwind 开发的导航网站，旨在帮助用户方便地管理和组织自己的导航链接。

*   [yusixian/cosine-toolbox](https://github.com/yusixian/cosine-toolbox) - 🧰余弦工具箱🧰 一个使用 React + Next.js + Typescript + Tailwind 搭建的项目，集合了自己写/npm上的常用工具，在这里尝试各种技术实践

*   [yusixian/moe-copy-ai](https://github.com/yusixian/moe-copy-ai) - ✨ 萌萌哒的 AI 网页数据提取助手 ✨

*   [Amery2010/alive](https://github.com/Amery2010/alive) - 这是一个"数字死人开关"。如果你在 48 小时内没有签到，系统会自动通过 Resend 向你的紧急联系人发送求助邮件。
...
*   [hitmux/HitWar](https://github.com/hitmux/HitWar) - HitWar 是一款纯前端、高性能的塔防游戏。它不只是简单的“建塔-打怪”，而是一个包含了能量调度、领地扩张和战争迷雾的综合战场。
...
*   [JeasonLoop/react-xiuxian-game](https://github.com/JeasonLoop/react-xiuxian-game) - 一款文字修仙小游戏
...
*   [miku8miku/resume-alchemist](https://github.com/miku8miku/resume-alchemist) -

*   [shuxueshuxue/ink-and-memory](https://github.com/shuxueshuxue/ink-and-memory) - A responsive AI notebook that helps you record and explore your life.
...
*   [xiangruihu/InterReview](https://github.com/xiangruihu/InterReview) -
...
*   [lzwme/ql-scripts](https://github.com/lzwme/ql-scripts) - 支持青龙面板的脚本集
...
*   [zhufucdev/MotionEmulator](https://github.com/zhufucdev/MotionEmulator) - Xposed enabled location simulator with sensor support.

*   [auag0/HideMockLocation](https://github.com/auag0/HideMockLocation) - Xposed Module to Hide Mock Location Settings
...
*   [ZeroPointSix/empathize-with-others](https://github.com/ZeroPointSix/empathize-with-others) -

*   [sky22333/luleme](https://github.com/sky22333/luleme) - 撸了么 - 帮助机长起飞的健康记录安卓APP。
...
*   [wm94i/Work\_Review](https://github.com/wm94i/Work_Review) - 帮你自动记录一天中使用了哪些应用、浏览了哪些网页、在每个应用上花了多少时间

*   [bee-san/RustScan](https://github.com/bee-san/RustScan) - 🤖 The Modern Port Scanner 🤖

*   [arcana6264/whisper\_desktop](https://github.com/arcana6264/whisper_desktop) - Whisper GUI use rust.
...
*   [Inert0x/FreeProxyProxy](https://github.com/Inert0x/FreeProxyProxy) - A Proxy for Free Proxies \[DOGE]
...
*   [yincongcyincong/wechat\_chatter](https://github.com/yincongcyincong/wechat_chatter) - 微信(wechat hook macos) mac 收发消息逆向

*   [sunnoy/openclaw-plugin-wecom](https://github.com/sunnoy/openclaw-plugin-wecom) - 企业微信 AI 机器人插件 - Enterprise WeChat (WeCom) AI Bot plugin for OpenClaw. 支持流式输出、动态 Agent 管理、群聊集成、指令白名单等功能。
...
*   [xiaowanjiagit/linuxdo](https://github.com/xiaowanjiagit/linuxdo) - Linux.do 自动浏览助手 v2
...
*   [SunshineList/cf-short-url](https://github.com/SunshineList/cf-short-url) - CF worker 搭配KV空间的短链生成器

*   [SunshineList/cf-image](https://github.com/SunshineList/cf-image) - 基于CF的图床程序

*   [Gar-b-age/CookLikeHOC](https://github.com/Gar-b-age/CookLikeHOC) - 🥢像老乡鸡🐔那样做饭。主要部分于2024年完工，非老乡鸡官方仓库。文字来自《老乡鸡菜品溯源报告》，并做归纳、编辑与整理。CookLikeHOC.

*   [ZhjGo/fitgamerai](https://github.com/ZhjGo/fitgamerai) - FitGamerAI 是一个基于 Next.js 的创新体感互动游戏平台。

*   [systemoutprintlnhelloworld/interactive-prompt-iterator](https://github.com/systemoutprintlnhelloworld/interactive-prompt-iterator) - 交互式提示词优化器 - 基于 Next.js 和 AI SDK 的提示词优化工具

*   [sadose/practice-of-front-end-learning](https://github.com/sadose/practice-of-front-end-learning) - 前端学习的日常实践！
...
*   [Spr-Aachen/Twilight](https://github.com/Spr-Aachen/Twilight) - A CMS integrated static blog template | 支持后台管理的静态博客模板
...
*   [miku8miku/historical-timeline-explorer](https://github.com/miku8miku/historical-timeline-explorer) -
...
*   [0xsdeo/Hook\_JS](https://github.com/0xsdeo/Hook_JS) - 个人向自写JS Hook脚本

*   [biliCDN/bilicdn.github.io](https://github.com/biliCDN/bilicdn.github.io) - 哔哩CDN：公益性的jsdelivr镜像源

*   [L018/Trace](https://github.com/L018/Trace) - A Chrome extension for web analytics

*   [0xsdeo/AntiDebug\_Breaker](https://github.com/0xsdeo/AntiDebug_Breaker) - JavaScript Reverse Tools -- JS逆向工具
...
*   [TonyJiangWJ/Unify-Sign](https://github.com/TonyJiangWJ/Unify-Sign) - 聚合签到-薅羊毛-AutoJS
...
*   [id77/QuantumultX](https://github.com/id77/QuantumultX) - QuantumultX 自用配置

*   [leiyiyan/resource](https://github.com/leiyiyan/resource) -
...
*   [cityisempty/coinglass](https://github.com/cityisempty/coinglass) -

*   [Xposed-Modules-Repo/lozn.hookui](https://github.com/Xposed-Modules-Repo/lozn.hookui) - HOOKUI,No Code, dyamic analaysis
...
*   [Wenmoux/checkbox](https://github.com/Wenmoux/checkbox) - 　签到本地/云函数/青龙脚本( 刺猬猫小说|Acfun| 时光相册|书香门第论坛|绅士领域|好游快爆|埋堆堆|多看阅读|闪艺app|香网小说|晋江|橙光|什么值得买|网易蜗牛读书|网易云游戏平台|龙空论坛|NGA论坛|csdn|mt论坛|sf轻小说|猫耳FM|联想智选app|联想智选联想延保|联动云租车|数码之家|玩物志好物商店|togamemod|好书友论坛|鱼C论坛|帆软社区|村花论坛|纪录片之家|富贵论坛|ug爱好者|阅次元论坛|菜鸟图库|魅族社区|经管之家|有分享论坛|bigfun社区|阡陌居|HiFiNi|Hires后花园|曲奇云盘|游戏动力|百度爱企查|轻之文库|Qoo|天使动漫|耽漫|立创|捷配|花火论坛|17k小说|触站|起点读书|美团买菜|奥拉星积分商城|共创|麦当劳
...
*   [cc63/Surge](https://github.com/cc63/Surge) - Surge的配置与模块
...
*   [861172923/ADBToolkit](https://github.com/861172923/ADBToolkit) - 这是一个功能强大的安卓设备管理工具集，通过简单的菜单将常用的 ADB (Android Debug Bridge) 命令与高性能的 Scrcpy 投屏工具无缝集成。无论您是开发者、测试人员还是高级用户，这个脚本都能极大地提高您的工作效率。
...
*   [funnyzak/reqtap](https://github.com/funnyzak/reqtap) - ReqTap 是一个跨平台、零外部依赖的 HTTP 请求捕获与调试平台。单个可执行文件即可同时提供 CLI 采集器、SQLite 持久化存储以及带 WebSocket 的图形化控制台，帮助你在本地、容器、CI 乃至边缘节点快速观察、回放并转发各类 HTTP 调用。
...
*   [bbeyondllove/asr\_server](https://github.com/bbeyondllove/asr_server) - 一个基于 Sherpa-ONNX 的高性能语音识别服务，支持实时VAD（语音活动检测）、多语言语音识别和声纹识别功能。
...
*   [Koukyosyumei/AIJack](https://github.com/Koukyosyumei/AIJack) - Security and Privacy Risk Simulator for Machine Learning (arXiv:2312.17667)
...
*   [outlovecn/portainer-cn](https://github.com/outlovecn/portainer-cn) - portainer-ce 2.11 中文汉化版docker镜像，支持X86、ARM、ARM64

## Roff

*   [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) - 所有小初高、大学PDF教材。

*   [SanaAwan5/edgecase\_backdoors](https://github.com/SanaAwan5/edgecase_backdoors) -
...
*   [Yi-Z0/docker\_global\_transparent\_proxy](https://github.com/Yi-Z0/docker_global_transparent_proxy) - 使用clash +docker 进行路由转发实现全局透明代理
...
*   [Fankouzu/smart-contract](https://github.com/Fankouzu/smart-contract) - 学习智能合约
...
*   [hainingzhang/articles](https://github.com/hainingzhang/articles) - Articles on technical topics such as blockchain, container and IoT.
